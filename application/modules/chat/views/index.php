<div class="div-box-left" id="div-box-left">
    <div class="filter-social-container">
        ...
        <div class="filter-social-icon" data-toggle="tooltip" data-placement="bottom" title="Google talk"><img src="assets/image/icons/g-pluse.png" class="img-circle" id="chat-google" data-social-type="4" onclick="filterSocial(this)"></div>
...
<script>
    $(document).ready(function(){
        ...
        $('#div-contact-scroll-left').slimscroll({
            position: 'right',
            height: height,
            size:'5px',
            alwaysVisible:false
        });
        $('#div-contact-scroll-right').slimscroll({
            position: 'right',
            height: height,
            size:'5px',
            alwaysVisible:false
        ...
        //tabAjaxDataLoading('<?php echo base_url();?>chat/home', 'jqxTabs', 'Home', '', 0);
